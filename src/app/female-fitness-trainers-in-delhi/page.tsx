...
export const metadata: Metadata = {
  title: "Certified Female Fitness Trainers in Delhi - Lady Personal Coach at Home | Fit4Steps",
  description: "Book certified female fitness trainers at home in Delhi. Private workouts for weight loss, toning, PCOS/PCOD, thyroid & postnatal care in South Delhi & NCR.",
  keywords: [
...
export default function FemaleFitnessTrainersDelhiPage() {
  const schemaData = {
    ...
    '@graph': [
      {
        '@type': 'Service',
        '@id': 'https://fit4steps.com/female-fitness-trainers-in-delhi#service',
      ...
      },
      {
        ...
        itemListElement: [
          ...
          },
          {
            ...
            item: 'https://fit4steps.com/female-fitness-trainers-in-delhi',
          },
        ],
      },
      {
