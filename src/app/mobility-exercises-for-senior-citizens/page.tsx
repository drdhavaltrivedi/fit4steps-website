...
export const metadata: Metadata = {
  title: "Mobility Exercises for Senior Citizens - Fall Prevention & Balance | Fit4Steps",
  description: "Specialized in-home mobility and fall prevention training for elderly adults in Delhi NCR. Berg Balance Scale baseline, proprioceptive drills, gait restoration, and joint stability.",
  keywords: [
    "mobility exercises for senior citizens",
    "balance training for elderly delhi",
    "fall prevention exercises for seniors",
    "geriatric mobility trainer gurugram",
    "elderly gait and stability coaching noida"
  ],
  alternates: {
...
export default function MobilityBalancePage() {
  const schemaData = {
    ...
    '@graph': [
      {
        '@type': 'Service',
        '@id': 'https://fit4steps.com/mobility-exercises-for-senior-citizens#service',
      ...
      },
      {
        ...
        itemListElement: [
          ...
          },
          {
            ...
            item: 'https://fit4steps.com/mobility-exercises-for-senior-citizens',
          },
        ],
      },
      {
