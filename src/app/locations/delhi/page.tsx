...
export const metadata: Metadata = {
  title: 'Personal Fitness Trainer in South Delhi & Greater Kailash | Fit4Steps',
  description: 'Certified personal fitness trainer at home in South Delhi. Serving Greater Kailash (GK 1 & 2), Vasant Kunj, Panchsheel Park, Anand Lok, Defence Colony. Specialized in elderly fitness and personalized in-home workouts.',
  keywords: [
    ...
    'home personal trainer vasant kunj',
    'fitness trainer south delhi'
  ],
  alternates: {
    canonical: 'https://fit4steps.com/locations/delhi',
  },
};
...
export default function DelhiLocationPage() {
  const localBusinessSchema = {
    ...
    '@id': 'https://fit4steps.com/locations/delhi',
    url: 'https://fit4steps.com/locations/delhi',
