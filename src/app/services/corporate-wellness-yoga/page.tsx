...
export default function CorporateWellnessYogaPage() {
  ...
  return (
    <div>
      ...
      <SpecsMatrix
        badge="Enterprise Delivery Blueprint"
        title="How Fit4Steps Integrates into Corporate Workplaces"
        subtitle="On-site ergonomics, executive stress relief, and group wellness workshops across NCR."
        specs={specs}
      />
