...
export default function StressManagementTrainingPage() {
  ...
  return (
    <div>
      ...
      <SpecsMatrix
        badge="Protocol Blueprint"
        title="How Autonomic Reset Operates in Your Home"
        subtitle="Science-backed breathwork, vagus nerve stimulation, and restorative movement."
        specs={specs}
      />
