...
export const metadata: Metadata = {
  title: 'Personal Fitness Training for 50 Plus in Delhi NCR | Fit4Steps',
  description: 'Specialized 1-on-1 personal fitness training for adults aged 50 and above in Noida, Delhi & Gurugram. Safe metabolic support, bone density preservation, and injury-free exercise.',
  keywords: [
    ...
    'sarcopenia prevention workouts'
  ],
  alternates: {
...
export default function FiftyPlusPage() {
  const schemaData = {
    ...
    '@graph': [
      {
        '@type': 'Service',
        '@id': 'https://fit4steps.com/senior-fitness/fifty-plus#service',
      ...
      },
      {
        ...
        itemListElement: [
          ...
          },
          {
            ...
            item: 'https://fit4steps.com/senior-fitness/fifty-plus',
          },
        ],
      },
      {
