...
export const metadata: Metadata = {
  title: 'Senior Mobility & Balance Training | Fall Prevention at Home | Fit4Steps',
  description: 'Evidence-based in-home mobility and balance training for seniors in Noida, Delhi & Gurugram. Fall prevention, single-leg stability, proprioception, and gait correction.',
  keywords: [
    ...
    'proprioception training seniors'
  ],
  alternates: {
...
export default function MobilityBalancePage() {
  const schemaData = {
    ...
    '@graph': [
      {
        '@type': 'Service',
        '@id': 'https://fit4steps.com/senior-fitness/mobility-balance#service',
      ...
      },
      {
        ...
        itemListElement: [
          ...
          },
          {
            ...
            item: 'https://fit4steps.com/senior-fitness/mobility-balance',
          },
        ],
      },
      {
